...
% sadrzaj margine (da stane na jednu stranicu)
\usepackage{tocloft}
...
\includepdf[pages={1}]{downloaded/d1.pdf}
\includepdf[pages={1}]{downloaded/Izjava_o_originalnosti.pdf}
\includepdf[pages={1}]{downloaded/Izjava_o_suglasnosti.pdf}

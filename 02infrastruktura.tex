...
RCS postaje problematičan ukoliko je potrebno rad na više računala, to jest ukoliko više injženjera
...
Git ima tri moguća stanja datoteka: predan (engl.~committed), izmjenjen (engl.~modified) i priređen
...
Pojednostavno, sustav kontinuirane integracije nadgleda sve promjene nad sustav kontrole verzija.
...
proxy}). Nastao je s ciljem da ima bolje performance nego Apache web poslužitelj, a u tome je uspio.
Prema analizi iz 2017. godine, Nginx i dalje ima bolje performance nego
Apache~\citep{nguyen2017comparative}. Poduzeće Netcraft, koji se bavi istraživanjem web stranica i
servisa, obavlja istraživanje svakih mjesec dana. U veljači 2018. godine svaka četvrta internet
stranica bila je posluživana preko Nginx poslužitelja~\citep{Netcraft2018}.

Nginx kao~\citep{soni2016load}. TODO
